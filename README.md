...
These commands run the installer interactively. Add `--list` to inspect the available skills without installing them. To install non-interactively to the local project `.agents/skills` directory:
