...
1. Identify the format and load it with the right tool. Parse large artifacts in a subagent (the **ps-principle-guard-the-context-window** skill) and keep the reduced finding in the main thread.
