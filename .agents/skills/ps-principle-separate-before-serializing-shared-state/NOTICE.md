# ps-principle-separate-before-serializing-shared-state attribution

Derived from `principle-separate-before-serializing-shared-state` in Cursor Pstack 0.14.4 by Lauren Tan.
