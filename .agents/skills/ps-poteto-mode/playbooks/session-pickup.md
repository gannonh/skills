...
5. Verify the inherited claims against the original goal on the real artifact (the **ps-principle-prove-it-works** skill). A passing prior self-report is not the proof.
