...
metadata:
  ps-upstream-name: principle-prove-it-works
...
Keep the artifact visible for the human. Commit it only for large or complex work where the trail has to be auditable later, like a big port or migration (the **ps-show-me-your-work** skill). Most work just needs it visible, not committed.
