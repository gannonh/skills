...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.agents/skills/`, or plugin-installed paths under `the active harness's installed skill directory/`)
- a subagent prompts that name a skill path
