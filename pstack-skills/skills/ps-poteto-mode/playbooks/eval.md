...
- No `eval`, `test`, `judge`, `experiment`, `rubric`, `score`, `compare`, `benchmark`, `candidate`, or `ps-arena` in any directory, file, or prompt the candidate sees.
