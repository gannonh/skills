...
1. Route through the how workflow (`references/how/how.md`) (Explain mode for narrow questions, Critique mode for "are we sure?"). For motivation questions, also route through the why workflow (`references/why/why.md`).
...
4. Apply the unslop workflow (`references/unslop.md`) to the reply.
