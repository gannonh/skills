...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; see the **type-system-discipline** and [Boundary Discipline](references/principles/boundary-discipline.md).
...
Validate once where data crosses in; trust types inside. See [Boundary Discipline](references/principles/boundary-discipline.md).
