...
- Apply the unslop workflow (`references/unslop.md`) to every doc this skill touches. That skill owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
